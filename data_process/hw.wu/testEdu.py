    ...
    for line in f:
        ...
        for item in key_words:
            ...
            for check in seg_list:
                ...
                if check not in stopwords and single_line[3]!='0'and check.isdigit()!= True and check.isalpha()!= True\
...
model = svm.LinearSVC(C=0.5,penalty="l1", dual=False, tol=1e-3)
